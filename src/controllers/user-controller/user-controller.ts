...
import {UserService, UserServiceParams} from "../../service/user-service";
import {Controller} from "../../domain/controllers-and-serice";
...
export class UserController implements Controller {
    ...
    constructor(initUsersService:(params:UserServiceParams) => UserService) {
